...
int main(int argc, char *argv[])
{
    ...
    double Ta_kij, Tn_kij, P, T, h_tmp, T_tmp;
    ...
    for(iT=0;iT<nT;iT++)
    {
        ...
        for(iX=0;iX<nX;iX++)
        {
            ...
            T_tmp = T - 5; // Initial guess
            plicFuncs::calc_T_from_h(x, P, h_tmp, n, Pc, Tc, w, MW, Tb, SG, H8, kij_T, Ta_kij, Tn_kij, nT_kij, kij, T_tmp, 101, 1e-5, 1e-5);
