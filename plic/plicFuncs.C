...
)
{
    ...
    forAll(alpha1Cells, cellI)
    {
        ...
        if(alpha1_cellI > ALPHA_2PH_MIN && alpha1_cellI < ALPHA_2PH_MAX)
        {
            ...
            calc_cell_intfcGrad_coeffs(cellI, nf, C_intfc_cellI, Y1_flatFld, alpha1_flatFld, C_ph1_flatFld, curCellsAll, nSpecies, ALPHA_2PH_MIN, 1, dn1, Yeff1, debug, os);
            if(debug)
            {
                os<< "dn1 = " << dn1 << endl;
            }
            ...
            calc_cell_intfcGrad_coeffs(cellI, -nf, C_intfc_cellI, Y0_flatFld, alpha1_flatFld, C_ph0_flatFld, curCellsAll, nSpecies, ALPHA_2PH_MIN, 0, dn0, Yeff0, debug, os);
            if(debug)
            {
                os<< "dn0 = " << dn0 << endl;
            }
    ...
    for(label faceI=0; faceI<mesh.nInternalFaces(); faceI++)
    {
        ...
        {                        
            ...
            //phase-1
            //ensure nf direction is into the phase
            calc_cell_intfcGrad_coeffs(faceOwn, nf, C_intfc_cellI, Y1_flatFld, alpha1_flatFld, C_ph1_flatFld, curCellsAll, nSpecies, ALPHA_2PH_MIN, 1, dn1, Yeff1, debug, os);
            if(debug)
            {
                os<< "dn1 = " << dn1 << endl;
            }
            ...
            calc_cell_intfcGrad_coeffs(faceNei, -nf, C_intfc_cellI, Y0_flatFld, alpha1_flatFld, C_ph0_flatFld, curCellsAll, nSpecies, ALPHA_2PH_MIN, 0, dn0, Yeff0, debug, os);
            if(debug)
            {
                os<< "dn0 = " << dn0 << endl;
            }
        ...
        if(alpha1Own <= ALPHA_2PH_MIN && alpha1Nei >= ALPHA_2PH_MAX)
        {
            ...
            //phase-1
            //ensure nf direction is into the phase
            calc_cell_intfcGrad_coeffs(faceNei, nf, C_intfc_cellI, Y1_flatFld, alpha1_flatFld, C_ph1_flatFld, curCellsAll, nSpecies, ALPHA_2PH_MIN, 1, dn1, Yeff1, debug, os);
            if(debug)
            {
                os<< "dn1 = " << dn1 << endl;
            }
            ...
            calc_cell_intfcGrad_coeffs(faceOwn, -nf, C_intfc_cellI, Y0_flatFld, alpha1_flatFld, C_ph0_flatFld, curCellsAll, nSpecies, ALPHA_2PH_MIN, 0, dn0, Yeff0, debug, os);
            if(debug)
            {
                os<< "dn0 = " << dn0 << endl;
            }
...
)
{
    ...
    forAll(alpha1Cells, cellI)
    {
        ...
        if(alpha1_cellI > ALPHA_2PH_MIN && alpha1_cellI < ALPHA_2PH_MAX)
        {
            mS1Tot_cellI = (Js0[0].internalField()[cellI] - Js1[0].internalField()[cellI])*dt;
            mS1Tot_cellI /= (Ys1[0].internalField()[cellI] - Ys0[0].internalField()[cellI]);

            if(mS1Tot_cellI > 0)
            {
                max_mS = rho0_cellI*(1 - alpha1_cellI)*V_cellI;
                mS1Tot_cellI = min(max_mS, mS1Tot_cellI);
            }
            else
            {
                max_mS = rho1_cellI*alpha1_cellI*V_cellI;
                mS1Tot_cellI = -min(max_mS, -mS1Tot_cellI);
            }
            ...
            {                                
                ...
                {
                    os<< "Species: " << i << nl
                        << "Js1i = " << Js1[i].internalField()[cellI] << "  Js0i = " << Js0[i].internalField()[cellI] << "  dt = " << dt << nl
                        << "mS1i = " << mS1_cellI[i] << "  mS0i = " << mS0_cellI[i] << endl;
                }
                
                if(mS1_cellI[i] > 0)
                {
                    max_mSi = C0[i].internalField()[cellI]*V_cellI;

                    if(mS1_cellI[i] > max_mSi)
                    {
                        limiter = max_mSi/mS1_cellI[i];
                        limiter_min = min(limiter, limiter_min);                        
                    }

                    if(debug)
                    {
                        os<< "C0i = " << C0[i].internalField()[cellI] << "  V_cellI = " << V_cellI << "  max_mSi = " << max_mSi << nl
                            << "limiter = " << limiter << "  limiter_min = " << limiter_min << endl;
                    }
                }
                else if(mS1_cellI[i] < 0)
                {
                    max_mSi = C1[i].internalField()[cellI]*V_cellI;

                    if(mS0_cellI[i] > max_mSi)
                    {
                        limiter = max_mSi/mS0_cellI[i];
                        limiter_min = min(limiter, limiter_min);
                    }

                    if(debug)
                    {
                        os<< "C1i = " << C1[i].internalField()[cellI] << "  V_cellI = " << V_cellI << "  max_mSi = " << max_mSi << nl
                            << "limiter = " << limiter << "  limiter_min = " << limiter_min << endl;
                    }
                }
                else
            ...
            for(label i=0; i<nSpecies; i++)
            {
                mS1[i].internalField()[cellI] = mS1Tot_cellI*Ys1[i].internalField()[cellI] + Js1[i].internalField()[cellI]*dt;
                mS0[i].internalField()[cellI] = -mS1[i].internalField()[cellI];
            }

            mS1Tot.internalField()[cellI] = mS1Tot_cellI;
            mS0Tot.internalField()[cellI] = -mS1Tot_cellI;

            alphaS1.internalField()[cellI] = mS1Tot_cellI/rho1Cells[cellI];
            alphaS0.internalField()[cellI] = -mS1Tot_cellI/rho0Cells[cellI];
        }
        else
        {
            for(label i=0; i<nSpecies; i++)
        ...
        if(debug)
        {
            ...
            for(label i=0; i<nSpecies; i++)
            {
                os<< "mS1[" << i << "] = " << mS1[i].internalField()[cellI] << "  mS0[" << i << "] = " << mS0[i].internalField()[cellI] 
                    << endl;
            }
    ...
    for(label faceI=0; faceI<mesh.nInternalFaces(); faceI++)
    {
        ...
        if(alpha1Own >= ALPHA_2PH_MAX && alpha1Nei <= ALPHA_2PH_MIN)
        {
            mS1Tot_cellI = (Js0[0].internalField()[faceOwn] - Js1[0].internalField()[faceOwn])*dt;
            ...
            for(label i=0; i<nSpecies; i++)
            {
                mS1_cellI[i] = (Js0[i].internalField()[faceOwn] - Js1[i].internalField()[faceOwn])*dt;
                mS0_cellI[i] = -mS1_cellI[i];
                ...
                {
                    os<< "Species: " << i << nl
                        << "Js1i = " << Js1[i].internalField()[faceOwn] << "  Js0i = " << Js0[i].internalField()[faceOwn] << "  dt = " << dt << nl
                        << "mS1i = " << mS1_cellI[i] << "  mS0i = " << mS0_cellI[i] << endl;
                }
            }
            if(debug)
            {
                os<< "mS1Tot = " << mS1Tot_cellI << "  mS0Tot = " << mS0Tot_cellI << endl;  
            }
            ...
            if(mS1Tot_cellI > 0)
            {
                ...
                if(debug)
                {
                    os<< "rho0Own = " << rho0Own << "  (1 - alpha1Own) = " << (1 - alpha1Own) << "  VOwn = " << VOwn << nl
                        << "max_mSTot = " << max_mSTot << "  weight = " << weight << endl;
                }
            ...
            else if(mS1Tot_cellI < 0)
            {
                ...
                if(debug)
                {
                    os<< "rho1Nei = " << rho1Nei << "  alpha1Nei = " << alpha1Nei << "  VNei = " << VNei << nl
                        << "max_mSTot = " << max_mSTot << "  weight = " << weight << endl;
                }
        ...
        {            
            ...
            if(mS1Tot_cellI > 0)
            {
                max_mSTot = rho0Nei*(1 - alpha1Nei)*VNei;
                if(mS1Tot_cellI > max_mSTot)
                {
                    weight = max_mSTot/mS1Tot_cellI;
                }
                ...
                if(debug)
                {
                    os<< "rho0Nei = " << rho0Nei << "  (1 - alpha1Nei) = " << (1 - alpha1Nei) << "  VNei = " << VNei << nl
                        << "max_mSTot = " << max_mSTot << "  weight = " << weight << endl;
                }
            ...
            {
                max_mSTot = rho1Own*alpha1Own*VOwn;
                if(mS0Tot_cellI > max_mSTot)
                {
                    weight = max_mSTot/mS0Tot_cellI;
                }
                ...
                if(debug)
                {
                    os<< "rho1Own = " << rho1Own << "  alpha1Own = " << alpha1Own << "  VOwn = " << VOwn << nl
                        << "max_mSTot = " << max_mSTot << "  weight = " << weight << endl;
                }
        ...
        if(debug)
        {
            ...
            for(label i=0; i<nSpecies; i++)
            {
                os<< "mS1[" << i << "] = " << mS1[i].internalField()[faceOwn] << "  mS0[" << i << "] = " << mS0[i].internalField()[faceOwn] 
                    << endl;
            }
            ...
            for(label i=0; i<nSpecies; i++)
            {
                os<< "mS1[" << i << "] = " << mS1[i].internalField()[faceNei] << "  mS0[" << i << "] = " << mS0[i].internalField()[faceNei] 
                    << endl;
            }
        ...
        if(pp.coupled())
        {
            ...
            forAll(pmS1Tot, fcI)
            {
                ...
                if(debug)
                {
                    ...
                    os<< "mS1Tot = " << mS1Tot.internalField()[faceOwn] << "  mS0Tot = " << mS0Tot.internalField()[faceOwn] << nl
                        << "rho1 = " << rho1Cells[faceOwn] << "  rho0 = " << rho0Cells[faceOwn] << nl
                        << "alphaS1 = " << alphaS1.internalField()[faceOwn] << "  alphaS0 = " << alphaS0.internalField()[faceOwn] << nl
                        << "-----------------------------------------------------------------------------------" << nl
                        << endl;
                }
